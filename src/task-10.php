...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 10 - Invoking External JS</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Invoke an external JS file</li>
                    <li>This JS file should pop the cookie inside an alert box</li>
                    <li>After this, send the cookie to the attacker machine</li>
                </ol>
