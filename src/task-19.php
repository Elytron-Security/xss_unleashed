...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 19 - HTML Parsing Multi-Level</h1>
        <br>
        <br>
    ...
    <br>
    <h2 align="center"><a href="task-19/config/" id="config">Configs for User ID:3663</a></h2>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Find the Credit Card Number using XSS vulnerability</li>
                    <li>Exfilter the Credit Card Number and load it into an element with id "exploit"</li>
                    <li>Send the Credit Card Number to attacker machine</li>
                </ol>
