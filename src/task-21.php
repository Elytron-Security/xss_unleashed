...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 21 - XML Parsing Multi-Level</h1>
        <br>
        <br>
    ...
    <br>
    <h2 align="center" id="user_id"><a href="task-21/endpoints/" id="endpoints">API Endpoints</a></h2>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Find the Credit Card Numbers using XSS vulnerability</li>
                    <li>Exfilter the Credit Card Numbers and load it into an element with id "exploit"</li>
                    <li>Send the Credit Card Numbers to attacker machine</li>
                </ol>
