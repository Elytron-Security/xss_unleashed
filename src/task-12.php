...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 12 - Stealing Information from Auto-Complete Fields</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Write a malicious JS script which submit automatically de username and password to attacker machine after a few seconds</li>
                </ol>
