...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 6 - Changing Content to Social Engineering</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Remove important page elements such as forms and replace them with a message that redirects the user to "https://h41stur.com"</li>
                </ol>
