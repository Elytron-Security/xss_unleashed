...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 15 - Data Exfiltration with XMLHttpRequest POST</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>The Credit Card Number can be obtained via POST request to /task-15/creditCard/ with parameter user</li>
