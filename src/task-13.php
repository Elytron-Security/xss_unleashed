...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 13 - Stealing Information from Auto-Complete Fields with XMLHttpRequest</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>Enter an username and password and allow the browser to remeber it</li>
                    <li>Write a malicious JS script which submit automatically de username and password to attacker machine using an XMLHttpRequest() call after a few seconds</li>
                </ol>
