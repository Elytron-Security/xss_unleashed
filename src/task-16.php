...
<div class="wrapper">
 ...
 <!-- Navbar d-lg-none d-xl-none-->
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h1 align="center" class="h41stur">Task 16 - Getting Parameters from URL</h1>
        <br>
        <br>
        ...
        <div class="well">
            ...
            <p>
                <ol>
                    ...
                    <li>The Credit Card Number can be obtained via GET request to /task-16/creditCard/ with parameter user and the right token</li>
